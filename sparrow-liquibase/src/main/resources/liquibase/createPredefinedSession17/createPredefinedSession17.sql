...
--rollback   ALTER TABLE "PREDEFINED_SESSION" MODIFY ("CONTEXT_STRING" NULL);
...
--rollback   ALTER TABLE "PREDEFINED_SESSION" MODIFY ("NAME" NULL);
...
--rollback   ALTER TABLE "PREDEFINED_SESSION" MODIFY ("APPROVED" NULL);
...
--rollback   ALTER TABLE "PREDEFINED_SESSION" MODIFY ("PREDEFINED_TYPE" NULL);
...
--rollback   ALTER TABLE "PREDEFINED_SESSION" MODIFY ("SPARROW_MODEL_ID" NULL);
...
--rollback   ALTER TABLE "PREDEFINED_SESSION" MODIFY ("UNIQUE_CODE" NULL);
...
--rollback ALTER TABLE "PREDEFINED_SESSION" MODIFY ("PREDEFINED_SESSION_ID" NULL);
